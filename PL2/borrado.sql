...
CREATE INDEX IF NOT EXISTS idb_reservas_con_plazaid ON reservas(plazaid_plazas); 
...
CREATE INDEX IF NOT EXISTS idx_temp_vehiculos ON temp_vehiculos(vehiculoid);
CREATE INDEX IF NOT EXISTS idx_temp_clientes ON temp_clientes(clienteid); 
CREATE INDEX IF NOT EXISTS idx_temp_reservas ON temp_reservas(reservaid); 
