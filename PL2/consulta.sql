/*
CREATE INDEX IF NOT EXISTS idx_vehiculos_color ON vehiculos(color);
...
CREATE INDEX IF NOT EXISTS idx_reservas_fechainicio_month ON reservas ((EXTRACT(MONTH FROM fechainicio)));
CREATE INDEX IF NOT EXISTS idx_reservas_fechafin_month ON reservas ((EXTRACT(MONTH FROM fechafin)));
CREATE INDEX IF NOT EXISTS idx_clientes_provincia ON clientes(provincia);


CREATE INDEX IF NOT EXISTS idxh_vehiculos_color ON vehiculos USING hash (color);
CREATE INDEX IF NOT EXISTS idxh_incidencias_estado ON incidencias USING hash (estado);
CREATE INDEX IF NOT EXISTS idxh_reservas_vehiculoid ON reservas USING hash (vehiculoid_vehiculos);
*/
